...
function Jhin:IsUlting()
	return Utils:IsParticleInRange("jhin_base_r_viewcone", myHero.pos, myHero.boundingRadius)
end
...
function Leblanc:CastQcombo(unit)
...
function Leblanc:CastWcombo(unit)
...
function Leblanc:CastEcombo(unit)
...
--[[print("Q Range: " ..myHero:GetSpellData(_Q).range.. " | Q Width: " ..myHero:GetSpellData(_Q).width.. " | Q Speed: " ..myHero:GetSpellData(_Q).speed)
print("W Range: " ..myHero:GetSpellData(_W).range.. " | W Width: " ..myHero:GetSpellData(_W).width.. " | W Speed: " ..myHero:GetSpellData(_W).speed)
print("E Range: " ..myHero:GetSpellData(_E).range.. " | E Width: " ..myHero:GetSpellData(_E).width.. " | E Speed: " ..myHero:GetSpellData(_E).speed)
print("R Range: " ..myHero:GetSpellData(_R).range.. " | R Width: " ..myHero:GetSpellData(_R).width.. " | R Speed: " ..myHero:GetSpellData(_R).speed)]]
